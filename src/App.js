...
class App extends Component {
  ...
  renderReferenceImage = () => {
    ...
    const url = imagesList[randomNum].imageUrl
    return <img src={url} alt="match" className="referenceImage" />
  }
        ...
        <nav>
          ...
          <div className="score-container">
            <p className="score-text">
              Score: <span className="num">0</span>
            </p>
            ...
            {tabsList.map(each => (
              <li>
                <button
                  ...
                  type="button"
                  className={`tabItem ${
                    category === each.tabId ? `tab-tab` : ``
                  }`}
                  onClick={() => this.changeStyling(each.tabId)}
                >
                  {each.displayText}
                </button>
              </li>
